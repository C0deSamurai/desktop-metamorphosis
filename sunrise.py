"""This is from Michel Anders and his blog. All errors are his."""
...
class Sun:
    ...
    def __preptime(self, when):
        """Extract information in a suitable format from when, a
    ...
    def __calc(self):
        ...
        eqtime = 4 * deg(vary * sin(2 * rad(Mlong)) - 2 * Eccent * sin(rad(Manom)) +
                         4 * Eccent * vary * sin(rad(Manom)) * cos(2 * rad(Mlong)) - 0.5 * vary *
                         vary * sin(4 * rad(Mlong)) - 1.25 * Eccent * Eccent * sin(2 * rad(Manom)))
        ...
        self.solarnoon_t = (720 - 4 * longitude -
                            eqtime + timezone * 60) / 1440
        self.sunrise_t = self.solarnoon_t - hourangle * 4 / 1440
        self.sunset_t = self.solarnoon_t + hourangle * 4 / 1440

s = Sun(lat=35.153, long=-80.796)  # Charlotte, NC
